...
@Component({
  selector: 'app-modal-table-adicionar',
  templateUrl: './modal-table-adicionar.component.html',
  styleUrls: ['./modal-table-adicionar.component.scss']
})
export class ModalTableAdicionarComponent implements OnInit {
  ...
  constructor(
    ...
    private modal: MatDialogRef<ModalTableAdicionarComponent>,
